...
void TestAppMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void TestAppMain::OnWindowSizeChanged()
{
...
void TestAppMain::OnDeviceRemoved()
{
